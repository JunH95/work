...
print(np.add(x,y))   # 넘파이 함수 (유니버셜 함수) 속도 빠름 
...
print("\ndot은  numpy 모듈의 함수나 배열 객체의 인스턴스 메소드로 사용이 가능")
v = np.array([9,10])
w = np.array([11,12])
print(v * w)  # 요소별 곱
...
print(np.intersect1d(names1, names2))  # 교집합(중복 배제)
...
print("\n Broadcasting : 크기가 다른 배열 간의 연산 - 작은 배열을 여러 번 반복해 큰배열과 연산")
