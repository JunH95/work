...
# 파이썬 세션(session)은 웹에서 사용자 정보를 서버에 저장하는 기능을 말함
# (쿠키를 통해 세션 운영)
...
from datetime import timedelta  # 날짜/시간 가감해서 기간 설정하기 효과적
...
# 참고 키값 자동 생성 터미널창  > python -c "import secrets; print(secrets.token_hex(32))"
