...
# 같은 인덱스 끼리 연산, 불일치시 NaN 반환
print(s1 + s2)
print(s1.add(s2))  # sub, mul, div (사칙연산)  numpy 함수
...
print(df)
imsi = df.drop(1)  # 원본 데이터는 유지됨, 삭제된 결과가 새로운 DataFrame 으로 만들어짐
print(imsi)

# df.drop(1, inplace=True)  # 원본 데이터 삭제
# print(df)
